...
<body class="bg-dark">
    <div class="container text-white">
        <br>
        <div class="content" style="font-family: 'IBM Plex Sans Thai', sans-serif;">
        ...
        <div class="text-end" style="margin-top: 15px; margin-bottom: 15px;">
            <a href="index_dark.php" class="btn" style="background-color: rgb(178, 111, 198);"><i class="bi bi-arrow-left" style="color: #000;"></i></a>
        </div>
    </div>
</body>
</html>
